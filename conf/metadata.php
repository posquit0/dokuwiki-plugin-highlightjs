...
$meta['theme'] = array(
    'multichoice', '_choices' => array(
        ...
        'color-brewer', 'dark', 'darkula', 'default',
        'docco', 'dracula', 'far', 'foundation', 'github-gist',
        'github', 'googlecode', 'gruvbox-dark', 'gruvbox-light',
        'grayscale', 'hopscotch', 'hybrid', 'idea', 'ir-black',
        'kimbie', 'kimbie.dark', 'kimbie.light', 'magula',
        'mono-blue', 'monokai-sublime', 'monokai', 'obsidian',
        'paraiso-dark', 'paraiso-light', 'pojoaque',
        'qtcreator_dark','qtcreator_light','railscasts',
